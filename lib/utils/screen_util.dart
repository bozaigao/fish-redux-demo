...
num scaleSize(num width) => width * ScreenUtil.instance.scaleWidth * 2;
...
num setSp(num fontSize) => ScreenUtil.instance.allowFontScaling
    ? scaleSize(fontSize)
    : scaleSize(fontSize) / ScreenUtil.textScaleFactor;
